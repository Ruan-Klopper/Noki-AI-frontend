...
export default function LayoutWrapper({ children }: LayoutWrapperProps) {
  ...
  const isAuthRoute =
    pathname?.startsWith("/auth") || pathname === "/signin" || pathname === "/signup" || pathname === "/"
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen bg-background">
      <DevNav />
      <SidenavProvider isSidenavCollapsed={isSidenavCollapsed} isRightSidenavCollapsed={isRightSidenavCollapsed}>
        <NokiSidenav isCollapsed={isSidenavCollapsed} onToggle={handleToggleSidenav} />
        <ContentArea
          pageTitle={pageTitle}
        ...
        <TodosSidenav isCollapsed={isRightSidenavCollapsed} onToggle={handleToggleRightSidenav} />
      </SidenavProvider>
    </div>
  )
}
